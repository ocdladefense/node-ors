...
var OrsChapter = /*#__PURE__*/function () {
  ...
  _createClass(OrsChapter, [{
    ...
    key: "load",
    value: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resp) {
        var _this = this;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              return _context.abrupt("return", resp.arrayBuffer().then(function (buffer) {
